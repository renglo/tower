...
export default function ChatWidgetCommand({ key, item }: { key: string; item: { _out: string } }) {
  ...
  return (
        ...
        <span key={key} className="flex flex-col mb-4 w-full max-w-[75%] mx-auto">
            <div className="text-xs text-gray-400 bg-neutral-800/70 font-mono px-2 py-2 rounded-t flex flex-row items-center gap-1">Command <Command className="h-4 w-4" /></div>
